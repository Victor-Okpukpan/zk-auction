  ...
  const handleRevealBids = async (id: number) => {
    try {
      ...
      toast({
        ...
        description:
          "Your bid reveal has failed. Please contact the auction owner.",
      });
    }
  };
              ...
              >
                ...
                <div className="mt-4 space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    {isCompleted ? (
                      <span className="bg-gray-600 text-white text-[10px] px-2 py-1 rounded">
                        Completed
                      </span>
                    ) : (
                  ...
                  {phase === "Completed" && auction.bids.length > 0 && (
                    <p className="text-[10px] text-muted-foreground">
                      Highest Bid:{" "}
                      <strong>
                        {ethers.utils.formatEther(getHighestBid(auction))} ETH
                      </strong>
                    </p>
                  )}
